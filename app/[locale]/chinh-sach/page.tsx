  ...
  return (
    <div className="container-fh py-10 max-w-3xl">
      ...
      <p className="mt-4 text-slate-600 leading-relaxed">
        BanThangVN tôn trọng quyền riêng tư của bạn. Chúng tôi không bán dữ liệu cá nhân. Cookie phân
        tích (nếu có) chỉ dùng để cải thiện trải nghiệm. Liên hệ:{' '}
        <a href="mailto:privacy@banthangvn.com" className="text-brand-red hover:underline">
          privacy@banthangvn.com
        </a>
      </p>
    </div>
  );
